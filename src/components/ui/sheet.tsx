...
function SheetClose({
  ...
  return (
    <Dialog.Close
      ...
      className={cn(
        "rounded-md p-2 opacity-80 transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:ring-ring",
        className
      )}
      {...props}
    />
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Popup
        ...
        className={cn(
          "fixed inset-y-0 z-50 w-[min(88vw,22rem)] bg-background p-6 text-foreground shadow-xl outline-none transition-transform duration-300 data-[ending-style]:translate-x-full data-[starting-style]:translate-x-full",
