...
const route = publicRoutes.find((item) => item.path === "/elektronik-kart-tamiri");

export const metadata: Metadata = createPageMetadata({
  title: route?.title ?? "Elektronik Kart Tamiri | Orontes Teknoloji",
  description:
    route?.description ??
      ...
      <section className="bg-slate-950 px-4 pt-16 text-white sm:px-6 lg:px-8 lg:pt-20">
        <div className="mx-auto max-w-7xl">
          <Breadcrumbs
            items={[
              { name: "Ana Sayfa", path: "/" },
              { name: "Elektronik Kart Tamiri", path: "/elektronik-kart-tamiri" },
            ]}
          />
