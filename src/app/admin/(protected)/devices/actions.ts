...
export async function createDeviceGroup(formData: FormData) {
  ...
  const device = await repository.createDeviceGroup(
    parsed.data,
    session.userId,
  );
...
export async function archiveDeviceGroup(formData: FormData) {
  ...
  const repository = new PrismaDeviceGroupRepository(prisma);
  const device = await repository.archiveDeviceGroup(
    parsed.data.id,
    session.userId,
  );
...
export async function restoreDeviceGroup(formData: FormData) {
  ...
  const repository = new PrismaDeviceGroupRepository(prisma);
  const device = await repository.restoreDeviceGroup(
    parsed.data.id,
    session.userId,
  );
...
export async function deleteArchivedDeviceGroup(formData: FormData) {
  ...
  const repository = new PrismaDeviceGroupRepository(prisma);
  const device = await repository.deleteArchivedUnusedDeviceGroup(
    parsed.data.id,
  );
