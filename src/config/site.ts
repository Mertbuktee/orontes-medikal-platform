...
export const publicRoutes: PublicRoute[] = [
  ...
  {
    path: '/hizmetler',
    title: 'Medikal Cihaz Teknik Servis Hizmetleri',
    description:
      'Medikal cihaz bakım, onarım, elektronik kart tamiri, arıza analizi, kalibrasyon yönlendirmesi ve teknik destek hizmetleri.',
    priority: 0.9,
    changeFrequency: 'monthly',
  },
  {
    path: '/cihazlar',
    title: 'Medikal Cihaz Teknik Servisi',
    description:
  ...
  },
  {
    ...
    title: 'Hakkımızda',
    description:
      'Medikal cihaz bakım, onarım, elektronik kart tamiri ve teknik servis süreçlerinde güvenilir çözüm ortağı.',
    priority: 0.75,
    changeFrequency: 'monthly',
  },
  {
    path: '/servis-sureci',
    title: 'Medikal Cihaz Servis Süreci',
    description:
      'Cihaz kabul, arıza analizi, onarım, fonksiyon testi, kalite kontrol ve teslim adımlarını planlı şekilde yürütür.',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  {
  ...
  },
  {
    ...
    title: 'İletişim',
    description:
      'Telefon, e-posta, WhatsApp ve ofis konumu iletişim bilgileri.',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  {
  ...
  },
  {
    ...
    description:
      'Web sitesi çerez kullanımı, çerez kategorileri ve tercih yönetimi hakkında bilgilendirme.',
    priority: 0.3,
  ...
  },
  {
    ...
    description:
      'Web sitesi ve servis talebi süreçleri için gizlilik politikası bilgilendirmesi.',
    priority: 0.3,
    changeFrequency: 'yearly',
  },
  {
    ...
    description:
      'Kişisel verilerin korunması ve servis talebi süreçleri için KVKK aydınlatma metni.',
    priority: 0.3,
    changeFrequency: 'yearly',
  },
];
...
export function resolveSiteOrigin(env: NodeJS.ProcessEnv) {
  ...
  if (isLocalhost(url.hostname)) {
    throw new Error(
      'APP_ORIGIN cannot be localhost in production deployments.',
    );
  }
