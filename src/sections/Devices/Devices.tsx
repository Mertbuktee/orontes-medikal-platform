...
import { getDeviceIcon, getFeaturedDevices } from "@/content/devices";
...
const featuredDevices = getFeaturedDevices(6);
    ...
    <section id="cihazlar" className="relative overflow-hidden bg-slate-50 py-16 sm:py-20 lg:py-24">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {featuredDevices.map(({ id, title, shortDescription, capabilities, iconKey }) => {
