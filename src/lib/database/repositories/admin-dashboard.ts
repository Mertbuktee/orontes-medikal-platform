...
export class AdminDashboardRepository {
  ...
  async getSiteReadiness(settings: SiteSettings) {
    ...
    return [
      ...
      readiness("Varsayılan OG görsel", Boolean(settings.branding.defaultOgImageMediaId), "/admin/settings#branding"),
      readiness("Logo", Boolean(settings.branding.logoMediaId), "/admin/settings#branding"),
      readiness("Favicon", Boolean(settings.branding.faviconMediaId), "/admin/settings#branding"),
      readiness("Apple Touch Icon", Boolean(settings.branding.appleTouchIconMediaId), "/admin/settings#branding"),
